...
class AdressesControllerTest < ActionController::TestCase
  ...
  test "should create adress" do
    assert_difference('Adress.count') do
      post :create, adress: { city: @adress.city, country: @adress.country, state: @adress.state, street: @adress.street }
    end
  ...
  test "should update adress" do
    patch :update, id: @adress, adress: { city: @adress.city, country: @adress.country, state: @adress.state, street: @adress.street }
    assert_redirected_to adress_path(assigns(:adress))
  end
